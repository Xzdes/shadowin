...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Performing initial AI renderer test...");
    let _test_image = ai_renderer.generate_image("a blue square", 64, 64).await?;
    println!("AI renderer test successful!");
        ...
        match event {
            Event::WindowEvent { event, .. } => match event {
                ...
                WindowEvent::RedrawRequested => {
                    ...
                    ui.draw(&mut app_state, frame, WIDTH);
